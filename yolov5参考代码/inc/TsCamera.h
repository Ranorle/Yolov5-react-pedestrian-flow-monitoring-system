 ...
 * @return   void
 */
    void addObjectInfo ( output faceInfo );
/**
 ...
 */
    std::deque<output> getObjectInfoList();
 ...
 */
    ...
    //static void onBuffer ( GstAppSink* appsink, void* user_data );
 ...
 */
    ...
    std::deque<output> m_ObjectInfoQueue;
